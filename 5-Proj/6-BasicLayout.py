from PySide2.QtWidgets import (QApplication, QMenu, QDialog, QTextEdit,QDialogButtonBox,
                                QVBoxLayout, QMenuBar, QGroupBox, QHBoxLayout, QPushButton,
                                QLabel, QLineEdit, QFormLayout, QGridLayout, QSpinBox, QComboBox)
