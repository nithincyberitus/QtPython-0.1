...
import sys
from PySide2.QtWidgets import QApplication,QWidget,QPushButton,QLineEdit,QFormLayout,QInputDialog
class MyInputDialog(QWidget):
    ...
    def showChoiceDialog(self):
        ...
        text, ok = QInputDialog.getItem(self, 'Input Combo Dialog','Enter your choice:', strList)
        if ok:
